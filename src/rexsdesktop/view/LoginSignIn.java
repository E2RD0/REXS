 ...
 * @author user
 */
public class LoginSignIn extends javax.swing.JFrame {

    /**
     * Creates new form LoginSignIn
     */
    public LoginSignIn() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginSignIn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginSignIn().setVisible(true);
            }
        });
    }
